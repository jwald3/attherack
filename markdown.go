...
// renderMarkdown converts the small subset of Markdown that the coach emits into
// safe HTML. It is intentionally minimal (no dependencies): headings, bullet and
// numbered lists, GFM tables, horizontal rules, bold/italic/code inline spans,
// and paragraphs. All text is
// HTML-escaped first, so the output is injection-safe.
